...
class commentController {
    ...
    public function __construct($ctrl,$result,$eID){
        ...
        {
            echo '<div class="cParent odd">';
            echo '<span class=view onclick="sh(this,'.$p->commentID.')">[-]</span>';
            echo $p->getHiddenHeader();
            echo '<div class=cWrap id=cID'.$p->commentID.'>';
            echo '<div class="cLeft">';
            echo $p->voteArrows();            
            echo '</div><!--end cLeft-->';
            echo '<div class="cRight">';
            echo $p->getHeader();
            echo '<div class="discComment">'.$p->comment.'</div>';
            echo '</div><!--end cRight-->';
            echo $p->getFooter('odd');
            echo $p->getHiddenFooter();
       ...
       $arr = $this->recQuickSortNC(0,count($p->myChildren)-1,$p->myChildren);
        ...
        foreach($arr as $child)
            {                    
                ...
                echo '<div class="cChild '.$style.'">';
                echo '<span class=view onclick="sh(this,'.$child->commentID.')">[-]</span>';
                echo $child->getHiddenHeader();
                echo '<div class="cWrap" id=cID'.$child->commentID.'>';
                echo '<div class="cLeft">';
                echo $child->voteArrows();                
                echo '</div><!--end cLeft-->';
                echo '<div class="cRight">';
                echo $child->getHeader();                
                echo '<div class="discComment">'.$child->comment. '</div>';
                echo '</div><!--end cRight-->';
                echo $child->getFooter($style);
